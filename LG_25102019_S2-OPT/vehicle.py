...
#        self.intialValues(t)
    ...
    def intialValues(self,t, disBatterysize=None, disSoc=None, disUserTyp=None, socTarget=None):
...
#                                                  disUserType['Bis [Std]'][ra]))
        ...
        if self.carID == None: self.carID = 'ev' + str(self.arrivalTime) + '_' + str( np.random.random_integers(0,100000,1)[0])
