...
def discrimination_free(t, trafo_preload, n_ev):
    ...
    :type n_ev: int
    :return: Power that each charging point can load with.
    """
...
def first_come_first_served(t, charging_load, trafo_preload):
    ...
    :param trafo_preload: Time series data of the transformer preload and maximal load for the simulation period.
    :type trafo_preload: list
...
def control_with_battery(t, power, trafo_preload, n_ev):
    ...
    :param n_ev: Amount of connected vehicles.
    :type n_ev: int
    :return: Maximal power possible from transformer, Sum of the power of all charging points with a connected vehicle.
    """
